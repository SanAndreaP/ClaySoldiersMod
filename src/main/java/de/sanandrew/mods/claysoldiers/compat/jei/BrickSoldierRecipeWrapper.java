...
public class BrickSoldierRecipeWrapper
        implements IRecipeWrapper
{
    private final List<List<ItemStack>> input;
    private final ItemStack output;

    public BrickSoldierRecipeWrapper(JeiBrickSoldierRecipe type) {
    ...
    public static class Factory
            implements IRecipeWrapperFactory<JeiBrickSoldierRecipe>
    {
        @Override
