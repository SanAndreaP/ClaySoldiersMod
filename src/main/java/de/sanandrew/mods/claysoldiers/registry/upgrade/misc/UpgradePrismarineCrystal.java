...
public class UpgradePrismarineCrystal
        implements ISoldierUpgrade
{
    private static final ItemStack[] UPG_ITEMS = { new ItemStack(Items.PRISMARINE_CRYSTALS, 1) };
    ...
    public void onTick(ISoldier<?> soldier, ISoldierUpgradeInst upgradeInst) {
        ...
        if( soldierL.world.isRemote && MiscUtils.RNG.randomInt(25) == 0 ) {
            soldierL.world.spawnParticle(EnumParticleTypes.END_ROD, soldierL.posX, soldierL.posY + soldierL.getEyeHeight(), soldierL.posZ, 0.0D, 0.0D, 0.0D);
        }
    }
}
