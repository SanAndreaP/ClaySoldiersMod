...
{
    COBBLE(true, 40.0F, 0.4F, false, 0x4D3225, 0x919191, "cobble1", "cobble2"),
    MOSSY(true, 45.0F, 0.3F, false, 0x4D3225, 0x86A384, "mossy"),
    NETHERRACK(true, 35.0F, 0.4F, true, 0x4D3225, 0xCC3131, "netherrack"),
    MELON(true, 25.0F, 0.6F, false, 0xED5A5A, 0x0DDB11, "melon1", "melon2"),
    SANDSTONE(true, 30.0F, 0.4F, false, 0x4D3225, 0xFFF5AB, "sandstone1", "sandstone2", "sandstone3"),
    ENDSTONE(true, 45.0F, 0.4F, false, 0x4D3225, 0xDBD5A2, "endstone"),
    PUMPKIN(true, 25.0F, 0.6F, false, 0x4D3225, 0xF2BD0F, "pumpkin1", "pumpkin2"),
    LAPIS(true, 35.0F, 0.6F, false, 0x4D3225, 0x270AC9, "lapis"),
    CAKE(true, 30.0F, 0.6F, false, "cake", 0xA60000, 0xFFFFFF, "cake"),

    KAWAKO(false, 50.0F, 0.5F, true, 0x0, 0x0, "spec_kawako"),
