...
public class ModelWoolBunny
        extends ModelBase
        implements ModelJsonHandler<ModelWoolBunny, ModelJsonLoader.ModelJson>
{
    ...
    @Override
    public void onReload(IResourceManager iResourceManager, ModelJsonLoader<ModelWoolBunny, ModelJsonLoader.ModelJson> modelJsonLoader) {
