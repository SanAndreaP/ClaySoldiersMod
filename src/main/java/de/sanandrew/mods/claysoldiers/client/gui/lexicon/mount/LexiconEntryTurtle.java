...
public class LexiconEntryTurtle
        implements ILexiconEntryCraftingGrid
{
    ...
    public LexiconEntryTurtle() {
        this.icons = Arrays.stream(EnumTurtleType.VALUES).filter(EnumTurtleType::isVisible).map(ItemRegistry.DOLL_TURTLE::getTypeStack).toArray(ItemStack[]::new);
        this.prevPic = new ResourceLocation(CsmConstants.ID, "textures/gui/lexicon/page_pics/mounts/" + CsmConstants.ID + "_turtles.png");
    }
