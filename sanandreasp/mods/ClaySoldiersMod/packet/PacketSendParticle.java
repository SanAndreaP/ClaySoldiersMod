...
public class PacketSendParticle
{
    ...
    public static void sendParticle(int i, int dimID, double posX, double posY,
            double posZ, Double dataI, Double dataII, Double dataIII)
    {
        ...
        try
        {
            ...
            if (dataI != null)
            {
                ...
                if (dataII != null)
                {
                    ...
                    if (dataIII != null)
                        dos.writeDouble(dataIII.doubleValue());
                }
            }
            
            PacketDispatcher.sendPacketToAllAround(posX, posY, posZ, 128D,
                    dimID, new Packet250CustomPayload(CSMModRegistry.channelID,
                            bos.toByteArray()));
