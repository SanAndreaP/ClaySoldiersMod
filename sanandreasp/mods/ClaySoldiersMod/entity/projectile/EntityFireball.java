...
public class EntityFireball extends EntityGravelChunk
{
    ...
    public void onUpdate()
    {
        ...
        Vec3 vec3d1 =
                Vec3.createVectorHelper(posX + motionX, posY + motionY, posZ
                        + motionZ);
        MovingObjectPosition movingobjectposition =
                worldObj.rayTraceBlocks_do_do(vec3d, vec3d1, false, true);
        ...
        {
            vec3d1 =
                    Vec3.createVectorHelper(movingobjectposition.hitVec.xCoord,
        ...
        for (int l = 0; l < list.size(); l++)
        {
            ...
            MovingObjectPosition movingobjectposition1 =
                    axisalignedbb1.calculateIntercept(vec3d, vec3d1);
        ...
        if (movingobjectposition != null)
        {
            if (movingobjectposition.entityHit != null)
            {
                ...
                if (movingobjectposition.entityHit.attackEntityFrom(
                        DamageSource.causeThrownDamage(this, owner), attackU))
                {
                    int fire = 4;
                    ...
                    worldObj.playAuxSFXAtEntity(null, 1009,
                            (int) movingobjectposition.entityHit.posX,
                            (int) movingobjectposition.entityHit.posY,
                            (int) movingobjectposition.entityHit.posZ, 0);
                    setDead();
                }
            }
            else
        ...
        rotationPitch =
                prevRotationPitch + (rotationPitch - prevRotationPitch) * 0.2F;
