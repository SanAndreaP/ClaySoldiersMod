                ...
                && riddenByEntity instanceof EntityClayMan)
        {
            ...
            if (!ec.isDead)
            {
                if (ec.getFollowEntity() != null)
                {
                    ...
                    if (d <= 1.75D
                            && ec.boundingBox.minY > (ec.getFollowEntity().posY - 1.0D))
                    {
                        plunge = true;
                    }
                }
                if (ec.getEntityToAttack() != null)
                {
                    ...
                    if (d <= 1.75D
                            && ec.boundingBox.minY > (ec.getEntityToAttack().posY - 1.0D))
                    {
                        plunge = true;
                    }
                }
            ...
            if (moveForward != 0.0F && !plunge)
            {
                ...
                else
                {
                    ...
                    if ((worldObj.getBlockId(j, i1 - 1, l1) != 0 || worldObj
                            ...
                            && worldObj.getBlockId(j, i1 + 2, l1) == 0
                            && worldObj.getBlockId(j, i1 + 1, l1) == 0)
                    {
                        motionY = 0.2D;
                    }
                }
