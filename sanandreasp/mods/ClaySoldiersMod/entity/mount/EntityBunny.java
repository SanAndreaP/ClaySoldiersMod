...
public class EntityBunny extends EntityCreature implements IMount
{
    ...
    public EntityBunny(World world, double x, double y, double z, int i)
    {
        ...
        setPosition(x, y, z);
        renderDistanceWeight = 5D;
        worldObj.playSoundAtEntity(this, "step.cloth", 0.8F,
    ...
    public void readFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        this.dataWatcher
                .updateObject(19, nbttagcompound.getShort("bunnyColor"));
    ...
    {
        return spawnedFromNexus ? null : super.entityDropItem(par1ItemStack,
                par2);
    }
