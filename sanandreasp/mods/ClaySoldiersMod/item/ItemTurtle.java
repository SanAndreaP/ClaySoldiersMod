...
public class ItemTurtle extends Item
{
            ...
            int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                if (spawnTurtle(par3World, par1ItemStack.getItemDamage(),
    ...
    {
        this.itemIcon =
                par1IconRegister.registerIcon("ClaySoldiersMod:dollTurtle");
        this.sndIcon =
                par1IconRegister.registerIcon("ClaySoldiersMod:dollShell");
    }
