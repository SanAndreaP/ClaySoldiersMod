...
public class ItemClayMan extends Item
{
            ...
            int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                if (spawnClayMan(par3World, par1ItemStack.getItemDamage(),
                        (double) par4 + 0.5D, (double) par5 + var12,
                        (double) par6 + 0.5D)
    ...
    public int getColorFromItemStack(ItemStack is, int j)
    {
        ...
        {
            String clr =
                    SoldierTeams.getTeamsList().get(is.getItemDamage()).itemIconStr;
    ...
    {
        this.itemIcon =
                par1IconRegister.registerIcon("claysoldiersmod:dollClay");
    ...
    public Icon getIconFromDamage(int i)
    {
        return (SoldierTeams.getTeamsList().containsKey(i) && SoldierTeams
                ...
                .getTeamsList().get(i).itemIconIco : super.getIconFromDamage(i);
    }
