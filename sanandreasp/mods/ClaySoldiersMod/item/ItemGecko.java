...
public class ItemGecko extends Item
{
            ...
            int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                if (spawnGecko(par3World, par1ItemStack.getItemDamage(),
    ...
    public String getUnlocalizedName(ItemStack itemstack)
    {
        ...
        epona +=
                getTypeName(getTypes(i)[0]) + "-" + getTypeName(getTypes(i)[1]);
    ...
    {
        this.itemIcon =
                par1IconRegister.registerIcon("ClaySoldiersMod:dollGeckoBody");
        this.scndTexture =
                par1IconRegister.registerIcon("ClaySoldiersMod:dollGeckoSpots");
    }
}
