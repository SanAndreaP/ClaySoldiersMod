...
public class RenderGravelChunk extends Render
{
    ...
    public void renderTexturedQuad(int i, int j, int k, int l, int i1, int j1)
    {
        ...
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV(i + 0, j + j1, f, (k + 0) * f1, (l + j1)
                * f2);
        tessellator.addVertexWithUV(i + i1, j + j1, f, (k + i1) * f1, (l + j1)
                * f2);
        tessellator.addVertexWithUV(i + i1, j + 0, f, (k + i1) * f1, (l + 0)
                * f2);
        tessellator
                .addVertexWithUV(i + 0, j + 0, f, (k + 0) * f1, (l + 0) * f2);
        tessellator.draw();
    }
