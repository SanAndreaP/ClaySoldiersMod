...
public class UpgradeRenderHelper
{
    ...
    public static void onEggPreRender(UpgEggScent upg, RenderManager manager,
            IUpgradeEntity entity, float partTicks, ModelBase model)
    {
    ...
    public static void onEggPostRender(UpgEggScent upg, RenderManager manager,
            IUpgradeEntity entity, float partTicks, ModelBase model)
    {
    ...
    public static void onGlowPreRender(IUpgradeItem upg, RenderManager manager,
            IUpgradeEntity entity, float partTicks, ModelBase model)
    {
        // GL11.glEnable(GL11.GL_BLEND);
