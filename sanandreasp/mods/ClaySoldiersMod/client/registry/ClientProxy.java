...
public class ClientProxy extends CommonProxy
{
    ...
    {
        RenderingRegistry.registerEntityRenderingHandler(EntityClayMan.class,
                new RenderClayMan(new ModelClayMan(0F, 13F), 0.125F));
        RenderingRegistry.registerEntityRenderingHandler(
                EntityGravelChunk.class, new RenderGravelChunk());
        RenderingRegistry.registerEntityRenderingHandler(EntitySnowball.class,
                new RenderSnowball(Item.snowball));
        RenderingRegistry.registerEntityRenderingHandler(EntityFireball.class,
                new RenderSnowball(Item.fireballCharge));
        RenderingRegistry.registerEntityRenderingHandler(EntityHorse.class,
                new RenderHorse(new ModelHorse(0F, 12.75F), 0.15F));
        RenderingRegistry.registerEntityRenderingHandler(EntityPegasus.class,
                new RenderPegasus(new ModelPegasus(0F, 12.75F), 0.15F));
        RenderingRegistry.registerEntityRenderingHandler(EntityBunny.class,
                new RenderBunny(new ModelBunny(), 0.15F));
        RenderingRegistry.registerEntityRenderingHandler(EntityTurtle.class,
                new RenderTurtle(new ModelTurtle(0F, 12.75F), 0.15F));
        RenderingRegistry.registerEntityRenderingHandler(EntityGecko.class,
                new RenderGecko(new ModelGecko(), 0.15F));
        RenderingRegistry.registerEntityRenderingHandler(EntityClayNexus.class,
                new RenderClayNexus(new ModelClayNexus(), 0.15F));
    }
        ...
        switch (ID)
        {
            case 0:
                mc.effectRenderer.addEffect(new EntityDiggingFX(
                        ...
                        (Double) data[0] - (Double) data[3] - 0.5D,
                        (Double) data[1] - (Double) data[4] - 0.5D,
                        (Double) data[2] - (Double) data[5] - 0.5D,
                        (Block) data[6], rand.nextInt(6), (Integer) data[7]));
                break;
        }
    }
        ...
        switch (data[5])
        {
            case 0:
                mc.effectRenderer.addEffect(new EntityNoteFX(world,
                        entity.posX, entity.posY + 0.5D, entity.posZ, rand
                                .nextFloat(), rand.nextFloat(), rand
                                .nextFloat()));
                break;
            case 1:
                Vec3 vec3d =
                ...
                vec3d1 =
                        vec3d1.addVector(entity.posX,
                                entity.posY + entity.getEyeHeight(),
                                entity.posZ);
                world.spawnParticle((new StringBuilder()).append("iconcrack_")
                        .append(Item.porkRaw.itemID).toString(), vec3d1.xCoord,
            ...
            case 3:
                ...
                mc.effectRenderer.addEffect((new EntityDiggingFX(world, a, b,
                        c, 0.0D, 0.0D, 0.0D, Block.cloth, 0, 0)));
                break;
            case 4:
                a =
                        entity.posX
                ...
                c =
                        entity.posZ
                                + ((rand.nextFloat() - rand.nextFloat()) * 0.125D);
                mc.effectRenderer.addEffect(new EntityDiggingFX(world, a, b, c,
                        0.0D, 0.0D, 0.0D, Block.glowStone, 0, 0));
                break;
            case 5:
                a =
                        entity.posX
                ...
                c =
                        entity.posZ
                                + ((rand.nextFloat() - rand.nextFloat()) * 0.125D);
                mc.effectRenderer.addEffect(new EntityDiggingFX(world, a, b, c,
                        0.0D, 0.0D, 0.0D, Block.planks, 0, 0));
                break;
            case 6:
                a =
                        entity.posX
                ...
                c =
                        entity.posZ
                                + ((rand.nextFloat() - rand.nextFloat()) * 0.125D);
                mc.effectRenderer.addEffect(new EntityDiggingFX(world, a, b, c,
                        0.0D, 0.0D, 0.0D, Block.blockIron, 0, 0));
                break;
            case 7:
                a =
                        entity.posX
                ...
                c =
                        entity.posZ
                                + ((rand.nextFloat() - rand.nextFloat()) * 0.125D);
                mc.effectRenderer.addEffect(new EntityDiggingFX(world, a, b, c,
                        0.0D, 0.0D, 0.0D, Block.glass, 0, 0));
                break;
            case 8:
                a =
                        entity.posX
                ...
                c =
                        entity.posZ
                                + ((rand.nextFloat() - rand.nextFloat()) * 0.125D);
                mc.effectRenderer.addEffect(new EntityDiggingFX(world, a, b, c,
                        0.0D, 0.0D, 0.0D, Block.blockClay, 0, 0));
                break;
            case 9:
            ...
            case 10:
                ...
                mc.effectRenderer
                        .addEffect(new EntityNexusFX(
                                world,
                                nexus.posX + (rand.nextDouble() - 0.5D)
                                        * nexus.width,
                                (nexus.posY + rand.nextDouble() * nexus.height) - 0.25D,
                                nexus.posZ + (rand.nextDouble() - 0.5D)
                                        * nexus.width,
            ...
            case 11:
                for (int var1 = 0; var1 < 20; ++var1)
                {
                    ...
                    world.spawnParticle(
                            "explode",
                            entity.posX
                                    + (double) (rand.nextFloat() * entity.width * 2.0F)
                                    - (double) entity.width - var2 * var8,
                            entity.posY
                                    + (double) (rand.nextFloat() * entity.height)
                                    - var4 * var8,
                            entity.posZ
                                    + (double) (rand.nextFloat() * entity.width * 2.0F)
                                    - (double) entity.width - var6 * var8,
                            var2, var4, var6);
                }
                break;
            case 12:
                ...
                c =
                        entity.posZ
                                + ((rand.nextFloat() - rand.nextFloat()) * 0.125D);
                mc.effectRenderer.addEffect(new EntityDiggingFX(
                        CSMModRegistry.proxy.getClientWorld(), a, b, c, 0.0D,
                        0.0D, 0.0D, Block.gravel, 0, 0));
                break;
            case 13:
                a =
                        entity.posX
                ...
                mc.effectRenderer.addEffect(new EntityDiggingFX(
                        CSMModRegistry.proxy.getClientWorld(), a, b, c, 0.0D,
                        0.0D, 0.0D, Block.dirt, 0, 0));
                break;
            case 14:
                world.spawnParticle("reddust", entity.posX, entity.posY + 0.5F,
                        entity.posZ, -0.4F, 1F, 0F);
                break;
            case 15:
                world.spawnParticle("reddust", entity.posX, entity.posY + 0.5F,
                        entity.posZ, -1F, 0F, 0F);
                break;
            case 16:
                for (int j = 0; j < 4; j++)
                {
            ...
            case 17:
                ...
                break;
            case 18:
                world.spawnParticle("flame", entity.posX, entity.posY + 0.1D,
                        entity.posZ, 0.0D, 0.01D, 0.0D);
                break;
            case 19:
                world.spawnParticle("heart", entity.posX, entity.posY + 0.1D,
                        entity.posZ, 0.0D, 0.01D, 0.0D);
                break;
            case 20:
                for (int j = 0; j < 4; j++)
            ...
            case 21:
                world.spawnParticle(
                        ...
                        entity.posX + (rand.nextDouble() - 0.5D) * entity.width
                                * 0.5D,
                        (entity.posY + rand.nextDouble() * entity.height) - 0.05D,
                        entity.posZ + (rand.nextDouble() - 0.5D) * entity.width
                                * 0.5D, (rand.nextDouble() - 0.5D) * 0.75D,
