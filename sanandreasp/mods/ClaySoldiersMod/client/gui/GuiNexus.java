...
public class GuiNexus extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        {
            waveDurationSecTxt =
                    new GuiTextField(fontRenderer, l + 10, 110 + i1, 30, 15);
            waveDurationSecTxt.setText(Integer.toString(nexus.getWaveDurSec()));
            spawnSoldiersMaxTxt =
                    new GuiTextField(fontRenderer, l + 10, 110 + i1 + 20, 30,
                            15);
            spawnSoldiersMaxTxt.setText(Integer.toString(nexus
                    .getMaxSpwnSoldiers()));
            maxLivingSoldiersTxt =
                    new GuiTextField(fontRenderer, l + 10, 110 + i1 + 40, 30,
                            15);
            maxLivingSoldiersTxt.setText(Integer.toString(nexus
                    .getMaxLvngSoldiers()));
            randNoneItemsTxt =
                    new GuiTextField(fontRenderer, l + 10, 110 + i1 + 60, 30,
                            15);
            randNoneItemsTxt
                    .setText(Integer.toString(nexus.getChanceGetNone()));
            maxHealthTxt =
                    new GuiTextField(fontRenderer, l + 10, 110 + i1 + 80, 30,
                            15);
            ...
            GuiButton restore =
                    new GuiButton(3, l + 115, i1 + 45, 50, 20, "Restore");
            restore.enabled = nexus.isDestroyed();
            buttonList.add(restore);
            
            GuiButton rnditems =
                    new GuiButton(4, l + 115, i1 + 70, 50, 20, "Toggle");
            buttonList.add(rnditems);
        }
        
        GuiButton done =
                new GuiButton(5, l - 50, i1 + ySize - 20, 50, 20, "Done");
        buttonList.add(done);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j)
    {
        ...
        fontRenderer.drawString(s,
                l + (xSize / 2) - (fontRenderer.getStringWidth(s) / 2), i1 + 5,
                0x606060);
        ...
        else if (site == 1)
        {
            ...
            s =
                    ((ContainerNexus) inventorySlots).nexus.isDestroyed() ? "\2474Destroyed!"
                            : "\2472not Destroyed";
            ...
            s =
                    ((ContainerNexus) inventorySlots).nexus.hasRandItems() ? "\2472enabled"
                            : "\2474disabled";
    ...
    protected void keyTyped(char par1, int par2)
    {
        ...
        if (site == 1)
        {
            ...
            Packet250CustomPayload packet =
                    ...
                    {
                            entityIDByte[0], entityIDByte[1], entityIDByte[2],
                            entityIDByte[3], (byte) 0,
                            (byte) nexus.getWaveDurSec(),
                            (byte) nexus.getMaxSpwnSoldiers(),
                            (byte) nexus.getMaxLvngSoldiers(),
                            (byte) nexus.getChanceGetNone(),
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 1 && site == 0)
        {
            ...
            inventorySlots =
                    new ContainerNexus(
                            ...
                            ((ContainerNexus) prevInvSlots).nexus, false);
        ...
        Packet250CustomPayload packet =
                ...
                {
                        entityIDByte[0], entityIDByte[1], entityIDByte[2],
                        entityIDByte[3], (byte) 1, (byte) nexus.getHealth(),
