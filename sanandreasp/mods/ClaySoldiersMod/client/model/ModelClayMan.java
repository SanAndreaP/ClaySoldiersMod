...
public class ModelClayMan extends ModelBiped
{
            ...
            float f4, float f5, Entity entity)
    {
        ...
        bipedRightArm.rotateAngleX =
                MathHelper.cos(f * 0.6662F + 3.141593F) * 2.0F * f1 * 0.5F;
        ...
        RightLegArmor.rotateAngleX =
                speckyRightLeg.rotateAngleX = bipedRightLeg.rotateAngleX;
        RightLegArmor.rotateAngleY =
                speckyRightLeg.rotateAngleY = bipedRightLeg.rotateAngleY;
        RightLegArmor.rotateAngleZ =
                speckyRightLeg.rotateAngleZ = bipedRightLeg.rotateAngleZ;
