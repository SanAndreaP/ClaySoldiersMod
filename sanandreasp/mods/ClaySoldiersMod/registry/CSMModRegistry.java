...
public class CSMModRegistry
{
    ...
    private void setIDs()
    {
        String[] itemNames =
                new String[]
                {
                        "disruptor", "soldierDoll", "horseDoll", "pegasusDoll",
                        "brickDoll", "clayCookie", "turtleDoll", "bunnyDoll",
                        "geckoDoll", "shield", "clayNexus", "shearBlade",
                        "brickLump", "arenaPlacer", "upgshield"
                };
        
        manHelper.getCfgMan().addStaticItemIDs(itemNames, itemIDs);
        manHelper.getCfgMan().addProperty("capesEnabled", "miscStuff", true);
        
        manHelper.getCfgMan().loadConfig();
        
        itemIDs = manHelper.getCfgMan().getItemIDs(itemNames);
        capesEnabled=true;
        //capesEnabled = manHelper.getCfgMan().getSAPProperty("capesEnabled", "miscStuff").getBool();
    }
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        if (!manHelper.loading)
            return;
        FMLInterModComms.sendMessage("ClaySoldiersMod", "donateUrl", "http://cliffracerx.github.io/ClaySoldiersMod/donate.html");
        
        manHelper
                .initMan(
                        new SAPConfigManager("ClaySoldiersMod",
                                "ClaySoldiers.txt", "/sanandreasp/"),
                        new SAPLanguageManager("/sanandreasp/ClaySoldiers/",
                                "1.0", "Clay Soldiers Mod"),
        ...
        // Items
        clayDisruptor =
                (new ItemClayDisruptor(itemIDs[0] - 256)).setUnlocalizedName(
                        "claydisruptor").setCreativeTab(this.claySoldierTab);
        greyDoll =
                (new ItemClayMan(itemIDs[1] - 256, 0)).setUnlocalizedName(
                        "claydoll").setCreativeTab(this.claySoldierTab);
        horseDoll =
                (new ItemHorses(itemIDs[2] - 256, 0)).setUnlocalizedName(
                        "horsedoll").setCreativeTab(this.claySoldierTab);
        pegasusDoll =
                (new ItemHorses(itemIDs[3] - 256, 1)).setUnlocalizedName(
                        "pegasusdoll").setCreativeTab(this.claySoldierTab);
        bunnyDoll =
                (new ItemBunny(itemIDs[4] - 256)).setUnlocalizedName(
                        "bunnydoll").setCreativeTab(this.claySoldierTab);
        geckoDoll =
                (new ItemGecko(itemIDs[5] - 256)).setUnlocalizedName(
                        "geckodoll").setCreativeTab(this.claySoldierTab);
        brickDoll =
        ...
        turtleDoll =
                (new ItemTurtle(itemIDs[8] - 256)).setUnlocalizedName(
                        "clayturtle").setCreativeTab(this.claySoldierTab);
        shield =
        ...
        nexus =
                (new ItemNexus(itemIDs[11] - 256)).setUnlocalizedName(
                        "claynexus").setCreativeTab(this.claySoldierTab);
        shearBlade =
        ...
        brickLump =
                (new ItemGlobal(itemIDs[13] - 256))
                        ...
                        .setCreativeTab(this.claySoldierTab);
        arenaPlacer =
                (new ItemArenaPlacer(itemIDs[14] - 256)).setUnlocalizedName(
                        "arenaPlacer").setCreativeTab(this.claySoldierTab);
    }
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        NetworkRegistry.instance().registerGuiHandler(instance,
                new GuiHandler());
        TickRegistry
                .registerTickHandler(new Handler_ServerTicks(), Side.SERVER);
        ...
        EntityRegistry.registerModEntity(EntitySnowball.class, "CSM_SnowChunk",
                2, this, 64, 1, true);
        EntityRegistry.registerModEntity(EntityFireball.class, "CSM_FireChunk",
                3, this, 64, 1, true);
        EntityRegistry.registerModEntity(EntityHorse.class, "CSM_ClayHorse", 4,
                this, 64, 1, true);
        EntityRegistry.registerModEntity(EntityPegasus.class,
                "CSM_ClayPegasus", 5, this, 64, 1, true);
        EntityRegistry.registerModEntity(EntityBunny.class, "CSM_Bunny", 6,
                this, 64, 1, true);
        EntityRegistry.registerModEntity(EntityTurtle.class, "CSM_ClayTurtle",
                7, this, 64, 1, true);
        EntityRegistry.registerModEntity(EntityGecko.class, "CSM_Gecko", 8,
                this, 64, 1, true);
    ...
    public void postInit(FMLPostInitializationEvent evt)
    {
        ...
        String pegasiNames[] =
                new String[]
                {
                        "Dirt Pegasus", "Sand Pegasus", "Gravel Pegasus",
                        "Snow Pegasus", "Grass Pegasus", "Lapis Pegasus",
                        "Clay Pegasus", "Carrot Pegasus"
                };
        String bunnyNames[] =
                new String[]
                {
                        "White Bunny", "Orange Bunny", "Magenta Bunny",
                        "Light Blue Bunny", "Yellow Bunny", "Lime Bunny",
                        "Pink Bunny", "Gray Bunny", "Light Gray Bunny",
        ...
        String turtleNames[] =
                new String[]
                {
                        ...
                        "Melon Turtle", "Sandstone Turtle", "Endstone Turtle",
                        "Pumpkin Turtle"
                };
        ...
        for (i = 0; i < turtleNames.length; i++)
            manHelper.getLangMan().addLangProp(
                    turtleDoll.getUnlocalizedName(new ItemStack(turtleDoll, 1,
                            i)) + ".name", turtleNames[i]);
        ...
        for (i = 0; i < horsePegasiMaterial.length; i++)
        {
            GameRegistry.addRecipe(new ItemStack(horseDoll, 2, i), "#$#",
                    "# #", '$', Block.slowSand, '#', horsePegasiMaterial[i]);
        ...
        GameRegistry.addRecipe(new ItemStack(clayDisruptor, 1, 0), "#$#",
                "#@#", '$', Item.stick, '#', Item.clay, '@', Item.redstone);
        ...
        for (i = 0; i < turtleMaterial.length; i++)
        {
            GameRegistry.addRecipe(new ItemStack(turtleDoll, 2, i), " ##",
                    "$$#", '$', Block.slowSand, '#', turtleMaterial[i]);
        }
        
        GameRegistry.addSmelting(greyDoll.itemID, new ItemStack(brickDoll, 1),
                0F);
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(Item.shears, 1),
                new ItemStack(shearBlade, 1), new ItemStack(shearBlade, 1));
        ...
        {
            GameRegistry
                    .addShapelessRecipe(new ItemStack(greyDoll, 1, i + 1),
                            new Object[]
                            {
        ...
        GameRegistry
                .addShapelessRecipe(new ItemStack(greyDoll, 1, 17),
        ...
        for (i = 0; i < 20; i++)
        {
            GameRegistry.addRecipe(new ItemStack(greyDoll, 8, 0), "###", "#X#",
                    "###", '#', new ItemStack(greyDoll, 1, i), 'X',
                    new ItemStack(Item.bucketWater, 1));
            GameRegistry.addShapelessRecipe(new ItemStack(greyDoll, 1, 0),
                    new ItemStack(greyDoll, 1, i), new ItemStack(
                            Item.bucketWater, 1));
        }
        
        for (i = 0; i < 16; i++)
        {
            GameRegistry.addRecipe(new ItemStack(bunnyDoll, 4, i), "#X#", '#',
                    new ItemStack(Block.cloth, 1, i), 'X', new ItemStack(
                            Block.slowSand, 1));
        }
        ...
        for (i = 0; i < geckoMaterial.length; i++)
        {
            ...
            {
                int dmg = i * 4 + j;
                GameRegistry.addRecipe(new ItemStack(geckoDoll, 2, dmg), "1",
                        "2", "3", '1', geckoMaterial[i], '2', new ItemStack(
                                Block.slowSand, 1), '3', geckoMaterial[j]);
            }
        }
        
        GameRegistry.addRecipe(new ItemStack(nexus, 1), "CDC", "SOS", "OOO",
                'C', new ItemStack(Item.clay, 1), 'D', new ItemStack(
                        Item.diamond, 1), 'S',
                new ItemStack(Block.slowSand, 1), 'O', new ItemStack(
                        Block.obsidian, 1));
    ...
    private String
            getGeckoNameFromIndex(int ind, String[] prefStrings, int lang)
    {
        int x = 0, y = 0;
