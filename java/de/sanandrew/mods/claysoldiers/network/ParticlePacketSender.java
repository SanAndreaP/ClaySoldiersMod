...
public final class ParticlePacketSender
{
    public static void sendSoldierDeathFx(double x, double y, double z, int dimension, String team) {
        PacketProcessor.sendToAllAround(PacketProcessor.PKG_PARTICLES, dimension, x, y, z, 64.0D, Quintet.with(EnumParticleFx.FX_SOLDIER_DEATH, x, y, z, team));
    }
    ...
    public static void sendCritFx(double x, double y, double z, int dimension) {
        PacketProcessor.sendToAllAround(PacketProcessor.PKG_PARTICLES, dimension, x, y, z, 64.0D, Quartet.with(EnumParticleFx.FX_CRIT, x, y, z));
    }

    public static void sendHorseDeathFx(double x, double y, double z, int dimension, byte type) {
        PacketProcessor.sendToAllAround(PacketProcessor.PKG_PARTICLES, dimension, x, y, z, 64.0D, Quintet.with(EnumParticleFx.FX_HORSE_DEATH, x, y, z, type));
    }

    public static void sendBunnyDeathFx(double x, double y, double z, int dimension, byte type) {
        PacketProcessor.sendToAllAround(PacketProcessor.PKG_PARTICLES, dimension, x, y, z, 64.0D, Quintet.with(EnumParticleFx.FX_BUNNY_DEATH, x, y, z, type));
    }

    public static void sendTurtleDeathFx(double x, double y, double z, int dimension, byte type) {
        PacketProcessor.sendToAllAround(PacketProcessor.PKG_PARTICLES, dimension, x, y, z, 64.0D, Quintet.with(EnumParticleFx.FX_TURTLE_DEATH, x, y, z, type));
    }
    ...
    public static void sendMagmafuseFx(double x, double y, double z, int dimension) {
        PacketProcessor.sendToAllAround(PacketProcessor.PKG_PARTICLES, dimension, x, y, z, 64.0D, Quartet.with(EnumParticleFx.FX_MAGMAFUSE, x, y, z));
    }
}
